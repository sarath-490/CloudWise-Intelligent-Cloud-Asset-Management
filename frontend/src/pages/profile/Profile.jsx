  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-base text-slate-600 dark:text-slate-400">Manage your account information</p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
        <div className="px-6 py-6 border-b border-slate-200 dark:border-slate-800 bg-gradient-to-r from-indigo-50 to-white dark:from-indigo-900/20 dark:to-slate-900">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">{displayUser?.name || 'User'}</h2>
              <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">{displayUser?.email || ''}</p>
            </div>
            {!editing && (
              <Button variant="secondary" onClick={() => setEditing(true)} className="rounded-xl border border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700 transition-all font-semibold shadow-sm">
                <Edit2 size={18} />
                Edit Profile
              </Button>
            )}
