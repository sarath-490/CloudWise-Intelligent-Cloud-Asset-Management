  ...
  const features = [
    {
      ...
      color: 'indigo',
      demo: (
        <div className="relative w-full h-64 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-2xl border-2 border-dashed border-indigo-500/30 flex items-center justify-center group hover:border-indigo-500 hover:bg-indigo-500/5 transition-all cursor-pointer">
    ...
    },
    {
      ...
      demo: (
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl hover:bg-blue-500/20 transition-all cursor-pointer group">
            <div className="w-12 h-12 rounded-lg bg-blue-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              <FileSearch size={24} />
            </div>
            <div className="flex-1">
              <p className="font-bold text-foreground">Work Documents</p>
              <p className="text-sm text-muted-foreground">Auto-tagged by AI</p>
            </div>
            <Sparkles className="text-blue-600" size={20} />
          </div>
          <div className="flex items-center gap-3 p-4 bg-purple-500/10 border border-purple-500/20 rounded-xl hover:bg-purple-500/20 transition-all cursor-pointer group">
            <div className="w-12 h-12 rounded-lg bg-purple-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              <FolderOpen size={24} />
            </div>
            <div className="flex-1">
              <p className="font-bold text-foreground">Personal Files</p>
              <p className="text-sm text-muted-foreground">Smart sorted</p>
            </div>
            <Sparkles className="text-purple-600" size={20} />
          </div>
          <div className="flex items-center gap-3 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl hover:bg-emerald-500/20 transition-all cursor-pointer group">
            <div className="w-12 h-12 rounded-lg bg-emerald-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              <Brain size={24} />
            </div>
            <div className="flex-1">
              <p className="font-bold text-foreground">Reports & Data</p>
              <p className="text-sm text-muted-foreground">AI grouped</p>
            </div>
      ...
      demo: (
        <div className="space-y-4">
          <div className="flex gap-3">
            ...
            <div className="flex-1 bg-secondary p-4 rounded-2xl rounded-tl-none">
              <p className="text-sm font-medium text-foreground">"Show me all resumes from 2024"</p>
            </div>
          </div>
          <div className="flex gap-3">
    ...
    <div className="min-h-screen bg-background selection:bg-indigo-500/30 relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-border transition-all duration-300 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer" onClick={() => navigate('/')}>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 transform group-hover:rotate-12 transition-transform duration-300">
              <Cloud className="w-6 h-6 text-white" />
            </div>
            <span className="text-2xl font-black text-foreground tracking-tighter bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">CloudWise</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={toggleTheme}
              className="p-2.5 rounded-xl bg-secondary hover:bg-primary/10 text-muted-foreground hover:text-primary transition-all mr-2 group"
            ...
            <Link to="/login">
              <Button variant="ghost" className="font-bold text-sm hover:scale-105 transition-transform">Sign In</Button>
            </Link>
            <Link to="/register">
              <Button variant="primary" className="font-bold text-sm h-11 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-xl shadow-xl shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-105 transition-all">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <main className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-6xl lg:text-8xl font-black tracking-tighter text-foreground mb-8 leading-[0.9] max-w-5xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16">
            <Link to="/register" className="w-full sm:w-auto group">
              <Button variant="primary" size="large" className="w-full py-5 px-10 rounded-2xl text-lg font-black bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-2xl shadow-indigo-500/40 hover:shadow-indigo-500/60 transform hover:-translate-y-1 hover:scale-105 transition-all">
                Start Free Trial
                <ArrowRight className="inline ml-2 group-hover:translate-x-1 transition-transform" size={20} />
              </Button>
            </Link>
            <Link to="/login" className="w-full sm:w-auto group">
              <Button variant="secondary" size="large" className="w-full py-5 px-10 rounded-2xl text-lg font-black border-2 border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 hover:scale-105 transition-all">
                Sign In
              </Button>
            </Link>
          </div>
      ...
      <section id="demo" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass rounded-[48px] p-8 lg:p-12 border border-border shadow-2xl">
              <div className="mb-8">
